...
export const standAloneMode = import.meta.env.VITE_STANDALONE !== undefined && !import.meta.env.PROD;

const defaultStandalone = {
  safeAddress: import.meta.env.VITE_STANDALONE || "",
  chainId: import.meta.env.VITE_STANDALONE_CHAIN_ID ? Number(import.meta.env.VITE_STANDALONE_CHAIN_ID) : 11155111,
  threshold: 1,
...
const SafeContext = createContext(
  standAloneMode ? defaultStandalone : { safeAddress: "", chainId: 1, threshold: 1, owners: [], isReadOnly: true }
);
...
const SafeProvider = standAloneMode
  ? ({ children }) => <SafeContext.Provider value={defaultStandalone}>{children}</SafeContext.Provider>
